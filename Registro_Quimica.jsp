...
<title>Registro de Quimica y Biologia</title>
</head>
<body>

<h1>Registro de Química y Biología:</h1> <br>
...
<% 
    ...
    String InsertSQL = "Insert Into registro_quimica(Nombre, Apellido, Cedula, Curso) Values('" +nombre+ "','" +apellido+ "','" +cedula+ "','" +curso+ "')";
